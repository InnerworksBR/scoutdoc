...
export default function AgentForm({ agent }: AgentFormProps) {
    ...
    // Document generation (impl. 009 — modo livre, dirigido pelo system prompt)
        ...
        try {
            ...
            const res = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    // Modo livre: documento é dirigido pelo system prompt; sem template de seções.
                        ...
                        {producesDocument && (
                            <div className="space-y-4 pl-2 border-l-2 border-azure-200">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    />
                                    <p className="text-xs text-scout-400">
                                        Usado como nome do arquivo gerado. Se vazio, usa o nome do agente.
                                    </p>
                                </div>

                                <div className="bg-azure-50 border border-azure-100 rounded-lg p-3 text-xs text-azure-800 leading-relaxed">
                                    O documento é montado <strong>automaticamente com base nas instruções do agente (System Prompt)</strong> e na conversa.
                                    No chat, aparece o botão <strong>“Gerar documento”</strong>, que produz um PDF ou Word seguindo o que o agente foi configurado para escrever — sem precisar definir seções aqui.
                                    Descreva no System Prompt o formato/estrutura do documento que este agente deve gerar.
                                </div>
                            </div>
                        )}
                    </div>
